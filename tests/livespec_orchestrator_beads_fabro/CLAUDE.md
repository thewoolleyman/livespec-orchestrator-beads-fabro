# tests/livespec_orchestrator_beads_fabro/

Tests for the `livespec_orchestrator_beads_fabro` package under
`.claude-plugin/scripts/livespec_orchestrator_beads_fabro/`. Mirrors the
