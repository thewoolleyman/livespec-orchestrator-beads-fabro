...
# As livespec-impl-beads authors populate dev-tooling/checks/<slug>.py
...
# backed targets as livespec-impl-beads populates the scripts.
# ---------------------------------------------------------------
...
# check-tools) as livespec-impl-beads populates dev-tooling/checks/.
