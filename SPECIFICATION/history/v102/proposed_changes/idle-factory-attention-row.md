...
=== 2. scenarios.md: append a new scenario at the end of the file, after '## Scenario 119'. It is the converse of Scenario 84 (ready-work aging):
...
{
  "heading": "## Scenario 120 — An idle factory with dispatchable work surfaces its first dispatch",
